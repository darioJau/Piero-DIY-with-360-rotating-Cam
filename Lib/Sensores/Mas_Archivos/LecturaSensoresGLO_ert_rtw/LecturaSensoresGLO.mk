###########################################################################
## Makefile generated for Simulink model 'LecturaSensoresGLO'. 
## 
## Makefile     : LecturaSensoresGLO.mk
## Generated on : Wed May 15 18:55:57 2019
## MATLAB Coder version: 4.2 (R2019a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/LecturaSensoresGLO.elf
...
PRODUCT_NAME              = LecturaSensoresGLO
MAKEFILE                  = LecturaSensoresGLO.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/usuariomatlab/Documents/MATLAB/LectoraSensoresGLO
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/LecturaSensoresGLO.elf
...
DEFINES_STANDARD = -DMODEL=LecturaSensoresGLO -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/LecturaSensoresGLO_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/LecturaSensoresGLO_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/LecturaSensoresGLO_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<

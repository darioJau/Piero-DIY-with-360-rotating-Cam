 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Oct 24 13:26:58 2023
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                EncoderG31
...
extern void EncoderG31_Outputs_wrapper(int32_T *pos,
  const real_T *xD);
extern void EncoderG31_Update_wrapper(int32_T *pos,
  real_T *xD);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  EncoderG31_Outputs_wrapper(pos, xD);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  EncoderG31_Update_wrapper(pos, xD);
}
